...
def get_pdf_text(pdf_docs):
    ...
    for pdf in pdf_docs:
        ...
        pdf.seek(0)  # Reset the pointer to the beginning of the file
...
def get_conversational_chain():
    # Define a prompt template for answering questions based on the context
    prompt_template = """
    ...
    # Initialize the chat model and create a prompt template for the QA chain
